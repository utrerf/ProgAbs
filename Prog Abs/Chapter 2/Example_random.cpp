 ...
 * ------------------------
 * This file implements the Example_random.hpp interface
 */

#include <cstdlib>
#include <cmath>
#include <ctime>
#include "Example_random.hpp"
using namespace std;
 ...
 *       high - low + 1
 * 
 * can overflow the integer range. These calculations must therefore
 *  be performed using doubles instead of ints.
 */
...
/*
 * Implementation noted: randomReal
 * --------------------------------
 ...
 * ------------------------------------
 * The initRandomSeed function declares a statuc varuable that keeps track
